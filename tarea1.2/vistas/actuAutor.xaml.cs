...
public partial class actuAutor : ContentPage 
{
    ...
    private async void btnAgregar_Clicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert("!!!!!!!!!!","Porfavor Ingresar el nombre del autor", "¡¡¡¡¡¡¡¡¡¡¡¡");
            return;
        }
        else if (string.IsNullOrEmpty(nacionalidad))
        {
            await DisplayAlert("!!!!!!!!!!", "Porfavor seleccione la nacionalidad del autor", "¡¡¡¡¡¡¡¡¡¡¡");
            return;
        }
        ...
        try
        {
            if (controller != null)
            {
                ...
                {
                    await DisplayAlert("!!!!!!!", "Registro Actualizado", "¡¡¡¡¡¡¡¡");
