...
public partial class nuevoAutor : ContentPage
{
    ...
    private async void btnAgregar_Clicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert("¡¡¡¡¡¡", "Ingresar el nombre del autor", "!!!!!!");
            return;
        }
        else if (string.IsNullOrEmpty(nacionalidad))
        {
            await DisplayAlert("¡¡¡¡¡¡¡", "Seleccione nacionalidad del autor", "!!!!!!!");
            return;
        }
        ...
        try
        {
            if (controller != null)
            {
                ...
                {
                    await DisplayAlert("¡¡¡", "Registro Ingresado", "¡¡¡");
                    await Navigation.PopAsync();
                }
                else
                {
                    await DisplayAlert("!!!!!!", "Ocurrio un Error", "OK");
                }
            }
        }
        catch (Exception ex)
